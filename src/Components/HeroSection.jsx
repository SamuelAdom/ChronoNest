...
From classic chronographs to cutting-edge smartwatches, find the perfect companion for every moment.
                            ...
                            <div className='flex items-center gap-x-3 sm:text-sm'>
                                <a href="javascript:void(0)" className="flex items-center justify-center gap-x-1 py-4 px-4 text-white font-medium bg-black duration-150 hover:bg-white hover:text-black active:bg-gray-900 rounded-sm md:inline-flex">
                                SHOP PRODUCTS
